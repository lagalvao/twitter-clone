...
import { Home, Notifications, Email, FavoriteBorder, Person, ExitToApp, Rockeatseat } from '../../styles/Icons';
...
export const Logo = styled(Rockeatseat)`
    width: 41px;
    height: 41px;
...
export const MenuButton = styled.button`
    ...
    & + button:last-child{
        ...
        @media(min-width: 1280px){
            width: 100%;
            height: unset; /* Deixa o span como se nao tivesse alterado */
